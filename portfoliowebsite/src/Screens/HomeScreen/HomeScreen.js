...
import summaryDevelopersDesign from "../../images/developerdesign.svg";
import summaryResponsiveDesign from "../../images/responsivedesign.svg";
import summaryInnovativeSolutions from "../../images/innovativesolutions.svg";
import summaryPassion from "../../images/passion.svg";
            ...
            <div className="ideas-summary">
              <div className="col-sm-1 col-md-1">
                <div className="idea-img">
                  <img
                    className="img-responsive"
                    src={summaryInnovativeSolutions}
                    alt="design"
                  />
                </div>
              </div>
