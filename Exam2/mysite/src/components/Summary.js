                    ...
                    <div class="development-summary">
                        ...
                        <div class="responsive-summary">
                            <div class="col-sm-1 col-md-1 col-sm-offset-2 col-md-offset-2">
                                ...
                                <img alt="responsivedesign" className="img-responsive" src={responsivedesign} />
							</div>
                                </div>
                        ...
                        <div class="row">
                            <div class="ideas-summary">
                                <div class="col-sm-1 col-md-1">
                                    <div class="idea-img">
                                    <img alt="innovativesolutions" className="img-responsive" src={innovativesolutions} />
							</div>
                                    </div>
                                ...
                                <div class="passion-summary">
                                    <div class="col-sm-1 col-md-1 col-sm-offset-2 col-md-offset-2">
                                    <img alt="passion" className="img-responsive" src={passion} />
						</div>
