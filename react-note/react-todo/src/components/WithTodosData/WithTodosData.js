...
class WithTodosData extends React.Component {
  ...
  render() {
    ...
    if (render) {
      content = render(this.handleRemoveTodo, this.HandleAddTodo, this.state.todolist);
    } else if (children) {
      content = children(this.handleRemoveTodo, this.HandleAddTodo, this.state.todolist);
    }
