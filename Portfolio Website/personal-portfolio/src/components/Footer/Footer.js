        ...
        <div class="row">
          <div class="media-links">
            <div class="col-sm-1 col-md-1 col-sm-offset-4 col-md-offset-4">
              <div class="facebook">
                <a href="#">
                  <img class="img-responsive" src={facebook} alt="" />
                </a>
              </div>
            </div>
            ...
            <div class="col-sm-1 col-md-1">
              <div class="linkedin">
                <a href="#">
                  <img class="img-responsive" src={linkedIn} alt="linkedin" />
                </a>
              </div>
            </div>
            ...
            <div class="col-sm-1 col-md-1">
              <div class="pinterest">
                <a href="#">
                  <img class="img-responsive" src={pinterest} alt="pinterest" />
                </a>
              </div>
            </div>
            ...
            <div class="col-sm-1 col-md-1">
              <div class="email-icon">
                <a href="#">
                  <img class="img-responsive" src={email} alt="email" />
                </a>
              </div>
            </div>
          </div>
